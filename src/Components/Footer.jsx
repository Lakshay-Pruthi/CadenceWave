...
function Footer() {
    return (
        <>
            <div style={{ backgroundColor: 'var(--primary)', color: 'white', borderBottom: '2px solid white', paddingLeft: '5px' }}>Note : This app is supported by Spotify api and it is under going some changes so some functionalities might not be available or you me be redirected for those functionalities.</div>
