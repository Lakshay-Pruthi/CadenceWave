import artistIdData from "../../../data/Podcast/Podcasters.json";
...
async function fetchProfile(token) {
    ...
    const result = await fetch(`https://api.spotify.com/v1/shows?ids=${ids}&market=IN`, {
        method: "GET",
        headers: {
...
export async function loadPoadcastersData(token) {
